(function() {
    ...
    function getTickets() {
        ...
        .catch(error => {
            ...
            toastEl.querySelector(".toast-body").textContent = "Failed to get tickets. Please try refreshing the page.";
            toast.show();
    ...
    function search(searchString, processFn, params) {
        ...
        .catch(error => {
            clearTimeout(id);
            processFn({'results': [{'name': 'Unknown'}]}, params)
            console.error('Failed to search a user\'s information. ' + error);
        })
    }
    ...
    // Crete Bootstrap ticket modal object
    ...
    // Create Bootstrap toast for push notification
